...
(defun heuristica-final (estado)
    (+    (* 4.6125116 (irregularidades estado)) 
          (* 1.5971005 (bloco-mais-alto estado)) 
          (* 43.074406 (media-altura-colunas estado)) 
          (* 36.14417 (linhas-vazias estado)) 
          (* 56.156044 (buracos-totais estado))
          (* 12.795764 (espacos-livres-totais estado))))
